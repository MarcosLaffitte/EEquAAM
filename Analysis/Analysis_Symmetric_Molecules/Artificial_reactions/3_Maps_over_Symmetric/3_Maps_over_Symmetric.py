################################################################################
#                                                                              #
#  README - Program: 3_Maps_over_Symmetric.py                                  #
#                                                                              #
...
#    mapped-SMILES string. It should be noted that this script calls the RDT   #
#    application from the command line with the os package, since that mapper  #
#    is written in java  and thus RDT.jar should always be in the same dir.    #
#                                                                              #
...
#    followed by the 3 resulting maps, including the IDs of the corresponding  #
#    map. This information is ordered in columns separated by tabs as shown    #
...
#                                                                              #
#  - Run with:                                                                 #
#              python  3_Maps_over_Symmetric.py  [myFile.smiles]               #
#                                                                              #
#  - Expected output:                                                          #
#    (1)   myFile_aam.smiles                                                   #
#                                                                              #
...
# task message
print("\n")
print("* applying Graphormer mapper (CHY) ...")
