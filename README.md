...
<div align="center">
<strong>Figure 3 from <a href="https://match.pmf.kg.ac.rs/issues/m90n1/m90n1_75-102.html">[1]</a></strong><br/>
</div>
...
```
###### 3) Finally install other required dependencies with pip inside the eequaam conda environment:
```
